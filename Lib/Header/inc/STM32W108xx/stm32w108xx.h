...
typedef struct
{ 
  __IO uint32_t SLEEPCR;          /*!< Sleep timer control register,            Address offset: 0x0000 */
  __IO uint32_t LSI10KCR;         /*!< LSI Clock (10KHz) control register,      Address offset: 0x0004 */
  __IO uint32_t LSI1KCR;          /*!< LSI Clock (1KHz) control register,       Address offset: 0x0008 */
       uint32_t RESERVED0[4092];  
  __IO uint32_t HSECR1;           /*!< HSE Clock (24MHz) control register 1,    Address offset: 0x4000 */ 
  __IO uint32_t HSICR;            /*!< HSI Clock (12MHz) trim register,         Address offset: 0x4004 */
       uint32_t RESERVED1;
  __IO uint32_t PERIODCR;         /*!< Clock period control register,           Address offset: 0x400C */
  __IO uint32_t PERIODSR;         /*!< Clock period status register,            Address offset: 0x4010 */
  __IO uint32_t DITHERCR;         /*!< Clock dither control register,           Address offset: 0x4014 */
  __IO uint32_t HSECR2;           /*!< HSE Clock (24MHz) control register 2,    Address offset: 0x4018 */
  __IO uint32_t CPUCR;            /*!< Clock source select register,            Address offset: 0x401C */
       uint32_t RESERVED2;
  __IO uint32_t PCTRACECR;        /*!< Clock PC trace register,                 Address offset: 0x4024 */
} CLK_TypeDef;
...
typedef struct
{
  __IO uint32_t DSLEEPCR1;        /*!< Deep Sleep Control register 1            Address offset 0x00 */
       uint32_t RESERVED0[3];     /*!< Reserved 0x04 - 0x0C */
  __IO uint32_t DSLEEPCR2;        /*!< Deep Sleep Control register 2            Address offset 0x10 */
  __IO uint32_t VREGCR;           /*!< Voltage regulator Control register 1     Address offset 0x14 */
       uint32_t RESERVED1;        /*!< Reserved 0x18 */
  __IO uint32_t WAKECR1;          /*!< Wake Control register 1                  Address offset 0x1C */
  __IO uint32_t WAKECR2;          /*!< Wake Control register 2                  Address offset 0x20 */
  __IO uint32_t WAKESR;           /*!< Wake Status register                     Address offset 0x24 */
       uint32_t RESERVED2[2];     /*!< Reserved 0x2C - 0x30 */
  __IO uint32_t CPWRUPREQSR;      /*!< CPWRUPREQ status register                Address offset 0x30 */
  __IO uint32_t CSYSPWRUPREQSR;   /*!< CSYSPWRUPREQ status register             Address offset 0x34 */  
  __IO uint32_t CSYSPWRUPACKSR;   /*!< CSYSPWRUPACK status register             Address offset 0x38 */
  __IO uint32_t CSYSPWRUPACKCR;   /*!< CSYSPWRUPACK control register            Address offset 0x3C */
       uint32_t RESERVED3[12017]; /*!< Reserved 0x40 - 0xBC00 */
  __IO uint32_t WAKEPAR;          /*!< Wake GPIO Port A register                Address offset 0xBC04 */
  __IO uint32_t WAKEPBR;          /*!< Wake GPIO Port B register                Address offset 0xBC08 */
  __IO uint32_t WAKEPCR;          /*!< Wake GPIO Port C register                Address offset 0xBC0C */
       uint32_t RESERVED4[2];     /*!< Reserved 0xBC10 - 0xBC14 */
  __IO uint32_t WAKEFILTR;        /*!< Wake filter register                     Address offset 0xBC18 */
} PWR_TypeDef; 
...
typedef struct
{
  __IO uint32_t SR;               /*!< Reset Status Register                    Address offset: 0x2C */
} RST_TypeDef;
...
typedef struct
{
  __IO uint32_t CLKER; 	          /*!< FLASH controller clock enable register   Address offset: 0x0000 */
  __IO uint32_t CLKSR;	          /*!< FLASH controller clock status register   Address offset: 0x0004 */  
       uint32_t RESERVED0[4083];  /*!< Reserved 0x08 */
  __IO uint32_t ACR;              /*!< FLASH access control register,           Address offset: 0x3FD4 */
  __IO uint32_t KEYR;             /*!< FLASH key register,                      Address offset: 0x3FD8 */
  __IO uint32_t OPTKEYR;          /*!< FLASH OPT key register,                  Address offset: 0x3FDC */
  __IO uint32_t SR;               /*!< FLASH status register,                   Address offset: 0x3FE0 */
...
typedef struct
{
  __IO uint32_t DBGCR;            /*!< GPIO debug configuration register,       Address offset 0x00 */
  __IO uint32_t DBGSR;            /*!< GPIO debug status register,              Address offset 0x04 */
} GPIO_DBG_TypeDef;
...
typedef struct
{
  __IO uint32_t ISR;            /*!< Management Interrupt status Register,      Address offset 0x00 */
       uint32_t RESERVED0[15];  /*!< Reserved 0x0004 - 0x003C */  
  __IO uint32_t IER;            /*!< Management Interrupt Enable Register,      Address offset 0x40 */
} MGMT_IT_TypeDef;
...
typedef struct
{  
  __IO uint32_t PR;               /*!< EXTI pending register,                   Address offset 0x0000 */
       uint32_t RESERVED0[18];    /*!< Reserved 0x0004 - 0x004C */
  __IO uint32_t TSR[4];           /*!< EXTI trigger source register,            Address offset 0x0050 */
       uint32_t RESERVED1[1257];  /*!< Reserved 0x0054 - 0x13F4 */
  __IO uint32_t CR[2];            /*!< EXTI configuration register,             Address offset 0x13F8 */
} EXTI_TypeDef;
...
typedef struct
{
  __IO uint32_t CR;               /*!< WDG configuration register,      	      Address offset 0x00 */
  __IO uint32_t KR;               /*!< WDG key register,      	                Address offset 0x04 */
  __IO uint32_t KICKSR;           /*!< WDG kick-start register,      	          Address offset 0x08 */
} WDG_TypeDef;
...
typedef struct 
{
  __IO uint32_t CR;               /*!< SLPTMR configuration register,           Address offset 0x0000 */
  __IO uint32_t CNTH;             /*!< SLPTMR counter high register,            Address offset 0x0004 */
  __IO uint32_t CNTL;             /*!< SLPTMR counter high register,            Address offset 0x0008 */
  __IO uint32_t CMPAH;            /*!< SLPTMR compare A high register,          Address offset 0x000C */
  __IO uint32_t CMPAL;            /*!< SLPTMR compare A low register,           Address offset 0x0010 */
  __IO uint32_t CMPBH;            /*!< SLPTMR compare B high register,          Address offset 0x0014 */
  __IO uint32_t CMPBL;            /*!< SLPTMR compare B low register,           Address offset 0x0018 */
       uint32_t RESERVED0[4091];  /*!< Reserved 0x001C - 0x4008 */
  __IO uint32_t ISR;              /*!< SLPTMR interrupt status register,        Address offset 0x400C */
       uint32_t RESERVED1[2];     /*!< Reserved 0x4010 - 0x4018 */
  __IO uint32_t IFR;              /*!< SLPTMR force interrupts register,        Address offset 0x4020 */     
       uint32_t RESERVED2[12];    /*!< Reserved 0x4024 - 0x4050 */
  __IO uint32_t IER;              /*!< SLPTMR interrupt enable register,        Address offset 0x4054 */
} SLPTMR_TypeDef;
...
typedef struct
{  
  __IO uint32_t ISR;              /*!< ADC Interrupt Status Register,           Address offset: 0x0000 */
       uint32_t RESERVED0[15];    /*!< Reserved, 0x04 - 0x3C */                                           
  __IO uint32_t IER;              /*!< ADC Interrupt Enable Register,           Address offset: 0x0040 */
       uint32_t RESERVED1[2540];  /*!< Reserved, 0x44 - 0x27F0 */
  __IO uint32_t CR;               /*!< ADC Configuration Register,              Address offset: 0x27F4 */
  __IO uint32_t OFFSETR;          /*!< ADC Offset Register,                     Address offset: 0x27F8 */
  __IO uint32_t GAINR;            /*!< ADC Gain Register,                       Address offset: 0x27FC */
  __IO uint32_t DMACR;            /*!< ADC DMA Configuration Register,          Address offset: 0x2800 */
...
typedef struct
{
  ...
  __IO uint32_t SPISR;            /*!< SPI status register                      Address offset 0x04 */ 
       uint32_t RESERVED0[4];     /*!< Reserved 0x08 - 0x14 */
  ...
  __IO uint32_t SPICR;            /*!< SPI status register                      Address offset 0x1C */ 
       uint32_t RESERVED1[1];     /*!< Reserved 0x20 */
...
{
  __IO uint32_t DR;               /*!< Serial control Data register             Address offset 0x00 */
       uint32_t RESERVED0[1];     /*!< Reserved 0x04 */
  ...
  __IO uint32_t CR;               /*!< Serial control control register          Address offset 0x18 */
       uint32_t RESERVED2[2];     /*!< Reserved 0x1C - 0x20 */
  __IO uint32_t CRR1;             /*!< Serial control clock rate register 1     Address offset 0x24 */
  __IO uint32_t CRR2;             /*!< Serial control clock rate register 2     Address offset 0x28 */
} SC_I2C_TypeDef;
...
typedef struct 
{
  ...
  __IO uint32_t IMR;              /*!< TIM interrupt missed register            Address offset 0x18 */
       uint32_t RESERVED1[9];     /*!< Reserved 0x1C - 0x3C */
...
typedef struct
{
  __IO uint32_t ISR;              /*!< Interrupt Status register                Address offset 0x08 */
       uint32_t RESERVED0[15];    /*!< Reserved 0x0C - 0x44 */
  __IO uint32_t IER;              /*!< Interrupt Enable register                Address offset 0x48 */
       uint32_t RESERVED1[2];     /*!< Reserved 0x4C - 0x50 */
...
typedef struct
{
  ...
  __IO uint32_t DMARXERRBR;       /*!< DMA Rx error B register                  Address offset 0x38 */
       uint32_t RESERVED0[13];    /*!< Reserved 0x3C - 0x6C */
...
/********************  Bit definition for CLK_PCTRACECR register  *************/
#define  CLK_PCTRACECR_SEL                   ((uint32_t)0x00000001)        /*!< selects PC_TRACE source on bb_debug GPIO pins */
...
#define  ADC_CR_1                            ((uint32_t)0x00000002)        /*!< Bit1 reserved */
